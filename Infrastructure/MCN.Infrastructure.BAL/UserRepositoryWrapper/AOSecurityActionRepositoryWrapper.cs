...
{
    public class AOSecurityActionRepositoryWrapper : RepositoryBase<AosecurityAction>, IAOSecurityActionRepositoryWrapper
    {
        public AOSecurityActionRepositoryWrapper(RepositoryContext repositoryContext)
