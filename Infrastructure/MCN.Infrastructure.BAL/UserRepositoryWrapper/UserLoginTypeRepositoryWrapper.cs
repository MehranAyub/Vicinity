...
{
   public class UserLoginTypeRepositoryWrapper : RepositoryBase<UserLoginType>, IUserLoginTypeRepositoryWrapper
    {
        public UserLoginTypeRepositoryWrapper(RepositoryContext repositoryContext)
