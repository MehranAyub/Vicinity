...
{
    public class UserEntityRepositoryWrapper : RepositoryBase<UserEntity>, IUserEntityRepositoryWrapper
    {
        public UserEntityRepositoryWrapper(RepositoryContext repositoryContext)
