...
{
    public class SecurityCategoryRepositoryWrapper : RepositoryBase<SecurityCategory>, ISecurityCategoryRepositoryWrapper
    {
        public SecurityCategoryRepositoryWrapper(RepositoryContext repositoryContext)
