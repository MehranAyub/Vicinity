...
{
    public class UserMultiFactorRepositoryWrapper:RepositoryBase<UserMultiFactor>, IUserMultiFactorRepositoryWrapper
    {
        public UserMultiFactorRepositoryWrapper(RepositoryContext repositoryContext):base(repositoryContext)
        {
