...
{
    public class EmailLogRepositoryWrapper:RepositoryBase<EmailLog>,IEmailLogRepositoryWrapper
    {
        public EmailLogRepositoryWrapper(RepositoryContext repositoryContext)
