...
{
    public class AOSecurityCategoryRepositoryWrapper : RepositoryBase<AosecurityCategory>, IAOSecurityCategoryRepositoryWrapper
    {
        public AOSecurityCategoryRepositoryWrapper(RepositoryContext repositoryContext)
