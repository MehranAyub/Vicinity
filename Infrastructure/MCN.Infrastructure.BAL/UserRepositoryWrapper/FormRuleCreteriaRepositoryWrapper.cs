...
{
    public class FormRuleCreteriaRepositoryWrapper : RepositoryBase<FormRuleCreteria>, IFormRuleCreteriaRepositoryWrapper
    {
        public FormRuleCreteriaRepositoryWrapper(RepositoryContext repositoryContext)
