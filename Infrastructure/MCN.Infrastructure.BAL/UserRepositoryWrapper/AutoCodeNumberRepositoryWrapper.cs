...
{
    public class AutoCodeNumberRepositoryWrapper : RepositoryBase<AutoCodeNumber>, IAutoCodeNumberRepositoryWrapper
    {
        public AutoCodeNumberRepositoryWrapper(RepositoryContext repositoryContext)
