...
{
    public class ProductModuleRepositoryWrapper : RepositoryBase<ProductModule>, IProductModuleRepositoryWrapper
    {
        public ProductModuleRepositoryWrapper(RepositoryContext repositoryContext)
