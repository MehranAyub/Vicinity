...
{
    public class SecurityRoleUserRepositoryWrapper : RepositoryBase<SecurityRoleUser>, ISecurityRoleUserRepositoryWrapper
    {
        public SecurityRoleUserRepositoryWrapper(RepositoryContext repositoryContext)
